<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="MakaleAra.aspx.cs" Inherits="Blogum.MakaleAra" %>
            ...
            <ItemTemplate>
                <div style="width:690px; margin:0 auto; height:auto;">
                    ...
                    <div style="width:710px; float:left; height:20px; line-height:20px; font-size:12px; background-color: #E8E8E8;">
                        <div style="margin-right:15px; float:left;" class="auto-style5">
